...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
    ...
    <div class="bg-white rounded-3xl p-8 md:p-12 mb-12 flex flex-col md:flex-row items-center gap-8 border border-zinc-200 shadow-sm relative overflow-hidden">
        ...
        <div class="relative z-10 shrink-0">
            <a href="{{ route('settings') }}" class="inline-flex h-10 px-5 bg-white border border-zinc-200 text-zinc-700 rounded-xl text-sm font-medium items-center justify-center hover:bg-zinc-50 hover:text-zinc-900 hover:border-zinc-300 transition-colors shadow-sm">
                Edit Profile
            </a>
        </div>
    </div>
    ...
    <div class="flex items-center justify-between mb-8">
        <h2 class="text-2xl font-bold tracking-tight text-zinc-900">Your Collection</h2>
            ...
            <a href="{{ route('books.show', $book->id) }}" class="group block">
                <div class="bg-white rounded-2xl p-5 border border-zinc-200 shadow-sm hover:shadow-floating hover:-translate-y-1 transition-all duration-300 flex items-start gap-5 h-full">
                   ...
                   <div class="flex flex-col justify-center h-full flex-grow py-1 min-w-0">
                       ...
                       <p class="text-sm text-zinc-500 mb-3 truncate">{{ $book->author_name }}</p>
                       ...
                       <div class="flex items-center justify-between mt-auto">
                           <div class="flex items-center gap-1">
                               ...
                               <span class="text-xs font-bold text-zinc-700">{{ number_format($book->rating, 1) }}</span>
                           </div>
    ...
    @else
        <div class="bg-white border border-dashed border-zinc-200 rounded-3xl p-16 text-center shadow-sm">
            ...
            <h3 class="text-lg font-bold tracking-tight text-zinc-900 mb-2">No books collected yet</h3>
            <p class="text-zinc-500 text-sm mb-6 max-w-sm mx-auto">Start browsing the library to find stories to add to your personal collection.</p>
