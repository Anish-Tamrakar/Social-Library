...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex flex-col sm:flex-row items-start gap-6 mb-12 pb-10 border-b border-zinc-200">
        ...
        <div class="shrink-0">
            <a href="{{ route('settings') }}" class="inline-flex items-center gap-1.5 text-sm font-medium text-zinc-600 border border-zinc-200 px-4 py-2 rounded-lg hover:bg-zinc-50 hover:border-zinc-300 transition-colors">
                Edit Profile
            </a>
        </div>
    </div>
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-base font-semibold text-zinc-900">Your Collection</h2>
                ...
                <div class="relative aspect-[2/3] w-full rounded-lg overflow-hidden bg-zinc-100 mb-3 flex-shrink-0">
                    ...
                    @else
                        <div class="absolute inset-0 flex flex-col justify-end bg-gradient-to-br from-zinc-600 to-zinc-900">
                            ...
                            <div class="p-4">
                                <p class="text-[10px] font-semibold uppercase tracking-widest text-zinc-400 mb-1">{{ $book->author->name ?? '' }}</p>
    ...
    @else
        <div class="py-20 flex flex-col items-center text-center">
            ...
            <p class="text-sm text-zinc-400 mt-1">Books you publish will appear here.</p>
